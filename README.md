...
This repo is **follow up study** of a project in CS542 Machine Learning Course in Boston University. [URL of original project](https://github.com/dongyj1/Sick_Team_3)

# Environment Requirment

Python 3.6.2, keras 2.0.6, numpy, pandas, matplotlib, scikit-learn, tensorflow r1.4 cpu version are required

We recommend you to use anaconda to install those packages, please run following commands in your anaconda prompt in Windows(terminal in macOS/Linux):
For scikit-learn:
...
4. For Gap Information problem run:
>python oga_analysis.py

5. For "Pile Up" & "Log Jam" problem run:
>python prob_4.py

6. For getting the belt speed change over time run:
>python speed_time_analysis.py

7. For getting the correlation between belt speed and LFT:
